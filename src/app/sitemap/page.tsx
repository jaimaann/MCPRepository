...
export default function Sitemap() {
  return (
    <>
      <Head>
        <title>Sitemap - MCPRepository.net</title>
        <meta name="description" content="Navigate all pages on MCPRepository.net with our comprehensive sitemap. Find MCP servers, resources, and more." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://mcprepository.net/sitemap" />
      </Head>
      ...
      <div className="container">
        <section className="section-heading">
          ...
          >
            Complete navigation guide to all pages on MCPRepository.net
          </motion.p>
        </section>
        ...
        >
          <div className="bg-decoration" style={{
            ...
            height: '200px',
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(133,20,75,0.05) 0%, rgba(255,255,255,0) 70%)',
            zIndex: -1
          }} />
          ...
          <section className="sitemap-section">
            ...
            <ul className="sitemap-links">
              ...
              <li>
                ...
                <span className="link-description">Navigate all pages on our site</span>
              </li>
            </ul>
          </section>
          
          {/* Remove or comment out sections that don't exist yet */}
          {/* 
          <section className="sitemap-section">
